...
import { getArticleBySlug, getArticleContributors } from '../selectors';
...
const ArticlePage = ({ classes, article, section, featuredMedia, contributors }) => {
  return (
...
const mapStateToProps = (state, ownProps) => ({
  ...
  contributors: getArticleContributors(state, ownProps),
  featuredMedia: {
