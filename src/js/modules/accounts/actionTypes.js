...
export const UPDATE_PASSWORD_PENDING = "accounts/UPDATE_PASSWORD_PENDING";
export const UPDATE_PASSWORD_FULFILLED = "accounts/UPDATE_PASSWORD_FULFILLED";
export const UPDATE_PASSWORD_REJECTED = "accounts/UPDATE_PASSWORD_REJECTED";
