export const SECTIONS = [
  ...
  },
  {
    ...
    quotes: [],
    deadline: "Application due November 12th, 2022",
    link:
      "https://docs.google.com/document/d/1Hso2Wj2DfZm5NwQ5VAgqgM9jbBOxjqpYgREUH6qgdTY/edit",
  },
  {
    name: "Features",
    imageLink: null,
  ...
  },
  {
    ...
    imageLink: null,
    description:
      "If you want your work to be featured on the front page, join News! Our department covers important school events, administrative changes, student organizations, school and student government policies, and out-of-school news. We also cover investigative pieces on controversial topics, such as the trend of uncontested elections. Writers also explore different ways to convey news through spreads, graphs, and surveys. If you’re interested in learning about exclusive Stuyvesant news before everyone else, informing the student body, interviewing students, teachers, administrators, alumni, and making connections while also improving your writing skills, APPLY TO NEWS!",
    quotes: [],
    deadline: "Application due November 4th, 2022",
    link:
      "https://docs.google.com/forms/d/e/1FAIpQLSeA77OEPjAFpdxWsTBN8G6n91KaTn_2DUEuOouHuBjeGbSODw/viewform",
  },
  {
    name: "Copy",
    imageLink: null,
  ...
  },
  {
    ...
    deadline: "Application due October 23rd, 2022",
    link:
      "https://docs.google.com/forms/d/e/1FAIpQLSf_6SAN2EHv_t9GwbzS46yDO5FrW1edzpfrmM5IRvWix_K9Eg/viewform",
  },
  {
    name: "Art",
    imageLink: null,
    ...
    deadline: "Application due October 28th, 2022",
    link:
      "https://docs.google.com/forms/d/e/1FAIpQLSe86KPZcmcm3WBaRuHNhUHkT0AnQhBoQyMxUj6pdzTdsMLrfw/viewform",
  },
  {
    name: "Science",
    imageLink: null,
    ...
    quotes: [],
    deadline: "Application due November 11th, 2022",
    link:
      "https://docs.google.com/document/d/1PTYnVsdjnox6vGrlOaZCBmOoQUK8f8VnSeCoxbX3Leo/edit",
  },
];
