...
describe('jss-compose', function () {
  ...
  describe('Array of refs composition', function () {
    ...
    it('should compose classes', function () {
      ...
      (0, _expect2.default)(sheet.getRule('e').className).to.be('e-id a-id b-id c-id');
      (0, _expect2.default)(sheet.getRule('f').className).to.be('f-id a-id b-id c-id');
    });
  ...
  describe('Mixed composition', function () {
    ...
    it('should compose classes', function () {
      ...
      (0, _expect2.default)(sheet.getRule('e').className).to.be('e-id a-id c d');
    });
